                    ...
                    @foreach ($tasks as $task)
                        <tr>
                                ...
                                <td
                                    ...
                                    <button wire:click="openCreateModal({{ $task }})" class="bg-green-800 text-white px-4 py-2 rounded-md hover:bg-green-700">
                                        Editar
                                    </button>
                ...
                <div class="m-8 my-20 max-w-[400px] mx-auto">
                    ...
                    <div class="flex flex-row">
                        <button class="p-3 bg-black rounded-full text-white w-full font-semibold"
                            wire:click="createorUpdateTask">{{ isset($miTarea->id) ? 'Actualizar' : 'Crear' }} tarea</button>
                        </button>
